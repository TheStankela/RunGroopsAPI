...
namespace RunGroops.Infrastructure.Migrations
{
    ...
    [Migration("20230726173653_Friendsv2")]
    partial class Friendsv2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RunGroops.Domain.EFModels.Friend", b =>
                {
            ...
            modelBuilder.Entity("RunGroops.Domain.EFModels.Race", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RunGroops.Domain.EFModels.Friend", b =>
                {
                    b.HasOne("RunGroops.Domain.EFModels.AppUser", "FromUser")
                        .WithMany("SentFriendRequests")
                        .HasForeignKey("FromUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("RunGroops.Domain.EFModels.AppUser", "ToUser")
